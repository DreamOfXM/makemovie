...
- Storyboards are versioned: a shot can be transitioned to approved, but an edit rewrites the row in place, so there is no per-revision history the way sources and scripts have
